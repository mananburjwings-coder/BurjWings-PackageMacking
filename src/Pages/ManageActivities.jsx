...
export default function ManageActivities() {
  ...
  const {
    ...
    staleTime: 0, // Ensure data is always considered old to trigger refetch
  });
  ...
  // --- FIX: Strict Delete with Cache Removal ---
  const deleteMutation = useMutation({
    mutationFn: (id) => base44.entities.Activity.delete(id),
    onMutate: async (deletedId) => {
      // Optimistically remove from UI
      await queryClient.cancelQueries({ queryKey: ["activities"] });
      const previousData = queryClient.getQueryData(["activities"]);
    ...
    onSuccess: () => {
      // Clear cache completely and force refetch from DB
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-600">
              Add and edit activity descriptions and prices
            </p>
          </div>
                ...
                <DialogContent className="max-w-md">
                  <DialogHeader>
                    ...
                    <DialogDescription className="sr-only">
                      Enter details for the activity including images and
                      pricing.
                    </DialogDescription>
                  </DialogHeader>
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex justify-between items-center pt-3 border-t">
                        <div className="text-blue-600 font-bold">
                          Adult: AED {activity.adult_price}
                        </div>
                        <div className="text-purple-600 font-bold">
                          Child: AED {activity.child_price}
                        </div>
                      </div>
                    </CardContent>
                  </Card>
